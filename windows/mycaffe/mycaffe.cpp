...
CCaffeCfr::CCaffeCfr(string deploy_prototxt, string network_caffemodel, string mean_binaryproto, string labels_txt) {
	if (firstUse) {
		::google::InitGoogleLogging("mycaffe.dll");
		firstUse = false;
	}
	reset(deploy_prototxt, network_caffemodel, mean_binaryproto, labels_txt);
}
